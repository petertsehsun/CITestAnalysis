...
parser.add_argument('--compare', help='Compare BC and Krypton test. Pass in two database names (e.g., tier1 tier1BC)', type=str, required=False, nargs='+')
...
parser.add_argument('--dbName', help='Name of the database which stores the test results (tier1, tier4, tier1BC)', type=str, required=False, default='tier1')
